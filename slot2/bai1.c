...
int main () {
    ...
    /*
    Giai thich them :
    int main() co nghia la chuong trinh duoc bat dau tu day;
    int la chuong trinh tra ve mot so nguyen cho he dieu hanh;
    {} la mot khoi lenh;
    ";" hoat dong tuong tu nhu dau cham het cau, dung de ket thuc cau
    return 0; 
    */
